...
void ImGui::ShowDemoWindow(bool* p_open) {
  ...
  ImGui::Text("dear imgui says hello! (%s) (%d)",
              IMGUI_VERSION,
              IMGUI_VERSION_NUM);
  ImGui::Spacing();
  ...
  if (ImGui::CollapsingHeader("Configuration")) {
    ...
    if (ImGui::TreeNode("Configuration##2")) {
      ...
      ImGui::SameLine();
      HelpMarker(
        "Pressing Enter will keep item active and select contents (single-line "
        "only).");
      ...
      HelpMarker(
        ...
        "or Tooltips enabled when making direct imgui API call! "
      ...
      HelpMarker(
        ...
        "being attached, otherwise IM_DEBUG_BREAK() options will appear to "
      ...
      HelpMarker(
        ...
        "IS DISABLED because it needs to be set at application boot-time to "
        "make sense. Showing the disabled option is a way to make this feature "
        "easier to discover.");
    ...
    if (ImGui::TreeNode("Backend Flags")) {
      HelpMarker(
        "Those flags are set by the backends (imgui_impl_xxx files) to specify "
        "their capabilities.\n"
...
static ExampleTreeNode* ExampleTree_CreateDemoTree() {
  static const char* root_names[] = {"Apple",
                                     "Banana",
                                     "Cherry",
                                     "Kiwi",
                                     "Mango",
...
static void DemoWindowWidgetsBasic() {
  ...
  if (ImGui::TreeNode("Basic")) {
...

    {
      ...
      const char* elems_names[Element_COUNT] = {"Fire",
                                                "Earth",
                                                "Air",
                                                "Water"};
...
static void DemoWindowWidgetsColorAndPickers() {
  ...
  if (ImGui::TreeNode("Color/Picker Widgets")) {
    ...
    ImGui::CheckboxFlags("ImGuiColorEditFlags_HDR",
                         &base_flags,
...
// natural type maximum, hence the /2.
    ...
    ImGui::SameLine();
    HelpMarker(
      "As with every widget in dear imgui, we never modify values unless there "
...
static void DemoWindowWidgetsDisableBlocks(ImGuiDemoWindowData* demo_data) {
  ...
  if (ImGui::TreeNode("Disable Blocks")) {
    ...
    ImGui::SameLine();
    HelpMarker(
      "Demonstrate using BeginDisabled()/EndDisabled() across other sections.");
    ImGui::TreePop();
  }
}
...
static void DemoWindowWidgetsDragsAndSliders() {
  ...
  if (ImGui::TreeNode("Drag/Slider Flags")) {
    ...
    ImGui::CheckboxFlags("ImGuiSliderFlags_NoInput",
                         &flags,
    ...
    ImGui::SameLine();
    HelpMarker(
      "Disable keyboard modifiers altering tweak speed. Useful if you want to "
...
static void DemoWindowWidgetsQueryingStatuses() {
  ...
  if (ImGui::TreeNode("Querying Item Status (Edited/Active/Hovered etc.)")) {
    ...
    char buf[1] = "";
    ImGui::InputText("unused",
                     buf,
                     IM_ARRAYSIZE(buf),
                     ImGuiInputTextFlags_ReadOnly);
    ImGui::SameLine();
    HelpMarker(
      "This widget is only here to be able to tab-out of the widgets above and "
      "see e.g. Deactivated() status.");
...
static void DemoWindowWidgetsSelectables() {
  ...
  if (ImGui::TreeNode("Selectables")) {
    ...
    if (ImGui::TreeNode("Alignment")) {
      HelpMarker(
        "By default, Selectables uses style.SelectableTextAlign but it can be "
        "overridden on a per-item "
        "basis using PushStyleVar(). You'll probably want to always keep your "
        "default situation to "
        "left-align otherwise it becomes difficult to layout multiple items on "
        "a same line");
...
struct ExampleSelectionWithDeletion : ImGuiSelectionBasicStorage {
  ...
  int ApplyDeletionPreLoop(ImGuiMultiSelectIO* ms_io, int items_count) {
    ...
    {
      ms_io->RangeSrcReset =
        true;  // Request to recover RangeSrc from NavId next frame. Would be ok
               // to reset even when NavIdSelected==true, but it would take an
               // extra frame to recover RangeSrc when deleting a selected item.
    ...
    if (ImGui::BeginTable("split", 3, ImGuiTableFlags_None)) {
      ...
      for (int side = 0; side < 2; side++) {
        ...
        if (side == 0) {
          ...
          child_visible = ImGui::BeginChild("1",
...
static void DemoWindowWidgetsSelectionAndMultiSelect(
  ...
  if (ImGui::TreeNode("Selection State & Multi-Select")) {
    ...
    if (ImGui::TreeNode("Multi-Select (trees)")) {
      HelpMarker(
        "This is rather advanced and experimental. If you are getting started "
        "with multi-select, "
      ...
      struct ExampleTreeFuncs {
        static void DrawNode(ExampleTreeNode*            node,
          ...
          ImGuiTreeNodeFlags tree_node_flags =
            ...
            ImGuiTreeNodeFlags_OpenOnDoubleClick;
          tree_node_flags |=
            ImGuiTreeNodeFlags_NavLeftJumpsToParent;  // Enable pressing left to
                                                      // jump to parent
    ...
    if (ImGui::TreeNode("Multi-Select (advanced)")) {
      ...
      if (ImGui::TreeNode("Options")) {
        ...
        ImGui::SameLine();
        HelpMarker(
          "TreeNode() is technically supported but... using this correctly is "
          "more complicated (you need some sort of linear/random access to "
          "your tree, which is suited to advanced trees setups already "
...
static void DemoWindowWidgetsTabs() {
  ...
  if (ImGui::TreeNode("Tabs")) {
    ...
    if (ImGui::TreeNode("Advanced & Close Button")) {
      ...
      if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags)) {
        for (int n = 0; n < IM_ARRAYSIZE(opened); n++)
          if (opened[n] && ImGui::BeginTabItem(names[n],
                                               &opened[n],
  ...
  if (ImGui::TreeNode("Text")) {
    ...
    if (ImGui::TreeNode("Word Wrapping")) {
      ...
      for (int n = 0; n < 2; n++) {
        ...
        if (n == 0)
          ImGui::Text(
            "The lazy dog is a good dog. This paragraph should fit within %.0f "
            "pixels. Testing a 1 character word. The quick brown fox jumps "
            "over the lazy dog.",
            wrap_width);
        else
          ImGui::Text(
        ...
        draw_list->AddRectFilled(marker_min,
                                 marker_max,
    ...
    if (ImGui::TreeNode("UTF-8 Text")) {
      ...
      ImGui::TextWrapped(
        "CJK text will only appear if the font was loaded with the appropriate "
        "CJK character ranges. "
        "Call io.Fonts->AddFontFromFileTTF() manually to load extra character "
        "ranges. "
...
static void DemoWindowWidgetsTextFilter() {
  ...
  if (ImGui::TreeNode("Text Filter")) {
    ...
    // own application.
    HelpMarker(
      "Not a widget per-se, but ImGuiTextFilter is a helper to perform simple "
      ...
      struct Funcs {
        static int MyResizeCallback(ImGuiInputTextCallbackData* data) {
          if (data->EventFlag == ImGuiInputTextFlags_CallbackResize) {
            ...
            my_str->resize(
              data->BufSize);  // NB: On resizing calls, generally data->BufSize
                               // == data->BufTextLen + 1
...
static void DemoWindowLayout() {
  ...
  if (ImGui::TreeNode("Child windows")) {
    ...
    {
      HelpMarker(
        "Drag bottom border to resize. Double-click bottom border to auto-fit "
        "to vertical contents.");
  ...
  if (ImGui::TreeNode("Widgets Width")) {
    ...
    ImGui::Text(
      "SetNextItemWidth/PushItemWidth(-Min(GetContentRegionAvail().x * 0.40f, "
      "GetFontSize() * 12))");
  ...
  if (ImGui::TreeNode("Scrolling")) {
    ...
    HelpMarker(
      ...
      "left/right, using SetScrollFromPosX(+1) will usually result in clipped "
      "text whereas the "
  ...
  if (ImGui::TreeNode("Text Clipping")) {
    ...
    HelpMarker(
      ...
      "This is often used internally to avoid altering the clipping rectangle "
      "and minimize draw calls.");
...
static void DemoWindowPopups() {
  ...
  if (ImGui::TreeNode("Menus inside a regular window")) {
    ImGui::TextWrapped(
      "Below we are testing adding menu items to a regular window. It's rather "
...
static void EditTableSizingFlags(ImGuiTableFlags* p_flags) {
  ...
  static const EnumDesc policies[] = {
    {             ImGuiTableFlags_None,
     "Default",                                        "Use default sizing policy:\n- ImGuiTableFlags_SizingFixedFit if ScrollX "
     "is on or if host window has ImGuiWindowFlags_AlwaysAutoResize.\n- "
     "ImGuiTableFlags_SizingStretchSame otherwise."},
    {   ImGuiTableFlags_SizingFixedFit,
     "ImGuiTableFlags_SizingFixedFit",                                                       "Columns default to _WidthFixed (if resizable) or _WidthAuto (if not "
     "resizable), matching contents width."},
    {  ImGuiTableFlags_SizingFixedSame,
     "ImGuiTableFlags_SizingFixedSame",                                                       "Columns are all the same width, matching the maximum contents "
     "width.\nImplicitly disable ImGuiTableFlags_Resizable and enable "
     "ImGuiTableFlags_NoKeepColumnsVisible."},
    {ImGuiTableFlags_SizingStretchProp,
     "ImGuiTableFlags_SizingStretchProp",                                                       "Columns default to _WidthStretch with weights proportional to their "
     "widths."},
    {ImGuiTableFlags_SizingStretchSame,
     "ImGuiTableFlags_SizingStretchSame", "Columns default to _WidthStretch with same weights."}
  };
  int idx;
...
static void EditTableColumnsFlags(ImGuiTableColumnFlags* p_flags) {
  ...
  ImGui::CheckboxFlags("_DefaultHide",
                       p_flags,
                       ImGuiTableColumnFlags_DefaultHide);
  ImGui::CheckboxFlags("_DefaultSort",
                       p_flags,
                       ImGuiTableColumnFlags_DefaultSort);
  if (ImGui::CheckboxFlags("_WidthStretch",
                           p_flags,
                           ImGuiTableColumnFlags_WidthStretch))
    *p_flags &=
  ...
  ImGui::CheckboxFlags("_NoHeaderLabel",
                       p_flags,
                       ImGuiTableColumnFlags_NoHeaderLabel);
  ImGui::CheckboxFlags("_NoHeaderWidth",
                       p_flags,
  ...
  ImGui::CheckboxFlags("_IndentEnable",
                       p_flags,
                       ImGuiTableColumnFlags_IndentEnable);
  ImGui::SameLine();
  HelpMarker("Default for column 0");
  ImGui::CheckboxFlags("_IndentDisable",
                       p_flags,
                       ImGuiTableColumnFlags_IndentDisable);
  ImGui::SameLine();
  HelpMarker("Default for column >0");
  ImGui::CheckboxFlags("_AngledHeader",
                       p_flags,
...
static void DemoWindowTables() {
  ...
  if (ImGui::TreeNode("Borders, background")) {
    ...
    ImGui::CheckboxFlags("ImGuiTableFlags_Borders",
                         &flags,
                         ImGuiTableFlags_Borders);
    ImGui::SameLine();
    HelpMarker(
  ...
  if (ImGui::TreeNode("Resizable, stretch")) {
    ...
    ImGui::SameLine();
    HelpMarker(
      "Using the _Resizable flag automatically enables the _BordersInnerV flag "
      "as well, "
  ...
  if (ImGui::TreeNode("Resizable, mixed")) {
    HelpMarker(
      ...
      "maybe two trailing columns to use _WidthStretch.");
    static ImGuiTableFlags flags =
  ...
  if (ImGui::TreeNode("Padding")) {
    ...
    ImGui::SameLine();
    HelpMarker(
      "Enable outer-most padding (default if ImGuiTableFlags_BordersOuterV is "
      "set)");
    ...
    ImGui::SameLine();
    HelpMarker(
      "Disable outer-most padding (default if ImGuiTableFlags_BordersOuterV is "
      "not set)");
  ...
  if (ImGui::TreeNode("Vertical scrolling, with clipping")) {
    HelpMarker(
      "Here we activate ScrollY, which will create a child window container to "
      "allow hosting scrollable contents.\n\n"
      "We also demonstrate using ImGuiListClipper to virtualize the submission "
      "of many items.");
    static ImGuiTableFlags flags =
      ImGuiTableFlags_ScrollY | ImGuiTableFlags_RowBg |
      ImGuiTableFlags_BordersOuter | ImGuiTableFlags_BordersV |
  ...
  if (ImGui::TreeNode("Horizontal scrolling")) {
    ...
    if (ImGui::BeginTable("table_scrollx", 7, flags, outer_size)) {
      ...
      ImGui::TableSetupColumn(
        "Line #", ImGuiTableColumnFlags_NoHide);  // Make the first column not
  ...
  if (ImGui::TreeNode("Row height")) {
    ...
    if (ImGui::BeginTable("table_share_lineheight",
                          2,
                          ImGuiTableFlags_Borders)) {
      ImGui::TableNextRow();
      ImGui::TableNextColumn();
    ...
    if (ImGui::BeginTable("table_changing_cellpadding_y",
                          1,
                          ImGuiTableFlags_Borders)) {
      ImGuiStyle& style = ImGui::GetStyle();
      for (int row = 0; row < 8; row++) {
  ...
  if (ImGui::TreeNode("Angled headers")) {
    ...
    ImGui::CheckboxFlags("_NoBordersInBody",
                         &table_flags,
                         ImGuiTableFlags_NoBordersInBody);
  ...
  if (ImGui::TreeNode("Context menus")) {
    HelpMarker(
      "By default, right-clicking over a TableHeadersRow()/TableHeader() line "
      "will open the default context-menu.\n"
  ...
  if (ImGui::TreeNode("Sorting")) {
    ...
    HelpMarker(
      ...
      "multiple column. TableGetSortSpecs() may return specs where (SpecsCount "
      "> 1).");
  ...
  if (ImGui::TreeNode("Advanced")) {
    ...
    if (ImGui::TreeNode("Options")) {
      ...
      if (ImGui::TreeNodeEx("Headers:", ImGuiTreeNodeFlags_DefaultOpen)) {
        ...
        ImGui::SameLine();
        HelpMarker(
          "Enable AngledHeader on all columns. Best enabled on selected narrow "
      ...
      if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen)) {
        ...
        HelpMarker(
          ...
          "will extend vertically if there are more rows (unless NoHostExtendY "
          "is set).");
...
void ImGui::ShowAboutWindow(bool* p_open) {
  if (!ImGui::Begin("About Dear ImGui",
                    p_open,
                    ImGuiWindowFlags_AlwaysAutoResize)) {
    ImGui::End();
    return;
  ...
  if (show_config_info) {
    ...
    ImGui::BeginChild(ImGui::GetID("cfg_infos"),
                      child_size,
                      ImGuiChildFlags_FrameStyle);
    ...
    ImGui::Text("io.DisplaySize: %.2f,%.2f",
                io.DisplaySize.x,
                io.DisplaySize.y);
...
bool ImGui::ShowStyleSelector(const char* label) {
  ...
  if (ImGui::BeginCombo(label,
                        (style_idx >= 0 &&
                         style_idx < IM_ARRAYSIZE(style_names))
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref) {
...

  {
    ...
    if (DragFloat(
          "FontSizeBase", &style.FontSizeBase, 0.20f, 5.0f, 100.0f, "%.0f"))
  ...
  if (BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
    if (BeginTabItem("Sizes")) {
      ...
      SliderFloat(
        "ScrollbarPadding", &style.ScrollbarPadding, 0.0f, 10.0f, "%.0f");
      ...
      SliderFloat(
        "TabBarOverlineSize", &style.TabBarOverlineSize, 0.0f, 3.0f, "%.0f");
      SameLine();
      HelpMarker(
        "Overline is only drawn over the selected tab when "
        "ImGuiTabBarFlags_DrawSelectedOverline is set.");
      DragFloat(
        "TabMinWidthBase", &style.TabMinWidthBase, 0.5f, 1.0f, 500.0f, "%.0f");
      ...
      SameLine();
      HelpMarker(
        "[Experimental] Tree lines may not work in all situations (e.g. using "
        "a clipper) and may incurs slight traversal "
      ...
      SliderFloat(
        "TreeLinesRounding", &style.TreeLinesRounding, 0.0f, 12.0f, "%.0f");
      ...
      SliderFloat(
        "ImageBorderSize", &style.ImageBorderSize, 0.0f, 1.0f, "%.0f");
      ...
      HelpMarker(
        ...
        "avoid displaying contents. Adjust if you cannot see the edges of your "
        "screen (e.g. on a TV where scaling has not been configured).");
    ...
    if (BeginTabItem("Colors")) {
      ...
      SetNextWindowSizeConstraints(ImVec2(0.0f,
                                          GetTextLineHeightWithSpacing() * 10),
                                   ImVec2(FLT_MAX, FLT_MAX));
      BeginChild("##colors",
                 ImVec2(0, 0),
...
static void ShowExampleAppFullscreen(bool* p_open) {
  ...
  if (ImGui::Begin("Example: Fullscreen window", p_open, flags)) {
    ...
    ImGui::Indent();
    ImGui::CheckboxFlags("ImGuiWindowFlags_NoTitleBar",
                         &flags,
...
struct ExampleAssetsBrowser {
  ...
  void Draw(const char* title, bool* p_open) {
    ...
    if (ImGui::BeginChild("Assets",
      ...
      ImGui::PushStyleVar(ImGuiStyleVar_ItemSpacing,
                          ImVec2(LayoutSelectableSpacing,
                                 LayoutSelectableSpacing));

      // Rendering parameters
      const ImU32 icon_type_overlay_colors[3] = {0,
          ...
          for (int item_idx = item_min_idx_for_current_line;
            ...
            if (item_is_visible) {
              ...
              if (display_label) {
                ...
                draw_list->AddText(ImVec2(box_min.x,
